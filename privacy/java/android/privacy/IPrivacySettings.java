...
public interface IPrivacySettings  {
    ...
    /**
     * Error occurred while obtaining the setting: indicates that all actions should be denied
     */
    public static final byte ERROR_EMPTY = 4;

    /**
     * Error occurred while obtaining the setting: indicates that all actions should be allowed
     */
